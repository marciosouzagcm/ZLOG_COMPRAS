...
* **Modelagem e Migração de Dados Coesa:** Banco de dados MySQL gerenciado via Flyway, eliminando redundâncias de saldos e garantindo integridade referencial estrita entre produtos, movimentações e estoques.
...
4. **Inicie a aplicação com o Vite:**
   ```bash
   npm run dev
...
## 📝 Licença
Este projeto está licenciado sob a Licença MIT. Você pode ver o
